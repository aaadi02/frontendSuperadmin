  ...
  const processData = (
    ...
    studentsData.forEach((student) => {
      ...
      if (
        ...
        Object.prototype.hasOwnProperty.call(deptCounts, student.departmentId)
      ) {
      ...
      if (student.admissionType) {
        if (
          Object.prototype.hasOwnProperty.call(admTypes, student.admissionType)
        ) {
      ...
      if (
        student.casteId &&
        Object.prototype.hasOwnProperty.call(catCounts, student.casteId)
      ) {
      ...
      if (
        student.streamId &&
        Object.prototype.hasOwnProperty.call(streamCounts, student.streamId)
      ) {
        ...
        if (student.admissionType) {
          if (
            Object.prototype.hasOwnProperty.call(
              monthlyData[monthYear].admissionTypes,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          {statItems.map((stat, index) => (
            <div
              key={index}
              className="bg-white rounded-xl shadow-md p-6 flex items-center transform transition-all hover:shadow-lg"
            >
            ...
            <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
              ...
              <div className="relative inline-block">
                ...
                {isMonthFilterOpen && admissionsByMonth.length === 0 && (
                  <div className="absolute z-10 w-48 mt-1 bg-white border border-gray-200 rounded-md shadow-lg">
                    <div className="py-1">
                      <p className="block w-full px-4 py-2 text-sm text-gray-500">
