...
//     try {
//       const res = await axios.get("https://backend-super-admin.vercel.app/api/streams", {
...
//     try {
//       const res = await axios.get(`https://backend-super-admin.vercel.app/api/superadmin/departments?streamId=${streamId}`, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
...
//     try {
//       await axios.delete(`https://backend-super-admin.vercel.app/api/superadmin/departments/${id}`, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
//       fetchDepartments(selectedStreamId);
//     } catch (err) {
...
//     try {
//       await axios.put(
//         `https://backend-super-admin.vercel.app/api/superadmin/departments/${id}`,
